...
**After submitting**: CI runs syntax checks and the unit tests. GPU tests run on hardware before merge; say which tests you ran locally and on what GPU. Merging to `main` deploys production.
