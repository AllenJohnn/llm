...
quick=(test_qwen.js test_smollm.js test_stream.js test_batch.js test_qwen_split.js test_qwen_stream.js test_topologies.js)
q38=(test_q38.js test_batch_q38.js test_mtp.js test_b4.js test_twins.js test_gemm.js test_q38_split.js test_mtp_split.js test_ctx.js test_reset.js test_batch_split.js)
